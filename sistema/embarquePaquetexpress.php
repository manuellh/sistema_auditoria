...
if (!empty($_SESSION['active'])) {
  ...
  if (isset($_POST['embarcar'])) {
    $DBDashboard->embarcarPaquetexpress();
  }
  ...
  <div class="d-flex" id="wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <div class="collapse show" id="collapseEmbarque">
          <div class="list-group">
            <a href="embarquePaquetexpress.php" class="list-group-item list-group-item-action list-group-item-dark">Paquetexpress</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4"><i class="fas fa-truck"></i> Embarques Paquetexpress</h1>
        ...
        <div class="row">
          ...
          <div class="col-lg-9 col-sm-12">
            <table id="tablaEmbarquesPaquete" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
              <thead>
                <tr>
